...
<!--[if IE 6]>
 ...
 function winopen(){
	...
	if(document.fr.id.value == 0){
		alert('아이디를 입력하세요');
		document.fr.id.value.focus();
	} else {
	
	var id = document.fr.id.value;
	var url="idcheck.jsp?userid="+id;
	 window.open(url,"checkForm", "width=500, height=500");
		...
		<article>
			...
			<form action="joinPro.jsp" id="join" method="post" name="fr">
				<fieldset>
					...
					<label>gender</label> 
					<input type="radio" name="gender" vlaue="남자">남자
					<input type="radio" name="gender" vlaue="여자">여자<br>
					<label>age</label> 
